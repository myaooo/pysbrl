...
def train_sbrl(data_file, label_file, _lambda, eta, max_iters, nchain, alphas):
    return _pysbrl.train_sbrl(data_file, label_file, _lambda, eta, max_iters, nchain, alphas)
