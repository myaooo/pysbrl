...
SWIGINTERN PyObject *_wrap_train_sbrl(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  int ecode10 = 0 ;
  int dim_temp11 ;
  int *data_temp11 = NULL ;
  int dim1_temp13 ;
  int dim2_temp13 ;
  double *data_temp13 = NULL ;
  int tmp_n16 = 1 ;
  char **tmp_strings16 = NULL ;
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  PyObject * obj2 = 0 ;
  PyObject * obj3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOO:train_sbrl",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8)) SWIG_fail;
  ...
  ecode9 = SWIG_AsVal_long(obj7, &val9);
  if (!SWIG_IsOK(ecode9)) {
